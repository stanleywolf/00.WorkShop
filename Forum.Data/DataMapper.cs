...
namespace Forum.Data
{
    public class DataMapper
    {
        ...
        private static void EnsureConfigFile(string congigPath)
        {
            if (!File.Exists(congigPath))
            {
                File.WriteAllText(congigPath,DEFAULT_CONFIG);
            }
        }
        ...
        private static Dictionary<string, string> LoadConfig(string configFilePath)
        {
            ...
            var config = content.Select(l => l.Split("="))
        ...
        public static void SaveCategories(List<Category> categories)
        {
            ...
            foreach (var category in categories)
            {
                ...
                string line = String.Format(categoryFormat, category.Id, category.Name, string.Join(",",category.PostsIds));
